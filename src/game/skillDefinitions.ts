...
export const skillDefinitions: readonly SkillDefinition[] = [
  {
    ...
    codeVariants: [
      { id: 'short-param', code: 'enemies.find(e => e.hp < 45)', lineMode: 'single' },
      { id: 'named-param', code: 'enemies.find(enemy => enemy.hp < 45)', lineMode: 'single' },
    ],
  },
  {
    id: 'pulse',
    ...
    codeVariants: [
      { id: 'short-param', code: 'enemies.find(e => e.name === "Goblin")', lineMode: 'single' },
      { id: 'named-param', code: 'enemies.find(enemy => enemy.name === "Goblin")', lineMode: 'single' },
    ],
  },
  {
    id: 'nova',
    ...
    codeVariants: [
      { id: 'short-param', code: 'enemies.find(e => e.hp > 60)', lineMode: 'single' },
      { id: 'named-param', code: 'enemies.find(enemy => enemy.hp > 60)', lineMode: 'single' },
    ],
  },
  {
    id: 'viper',
    ...
    codeVariants: [
      { id: 'short-param', code: 'enemies.filter(e => e.hp < 55)', lineMode: 'single' },
      { id: 'named-param', code: 'enemies.filter(enemy => enemy.hp < 55)', lineMode: 'single' },
    ],
  },
  {
    id: 'echo',
    ...
    codeVariants: [
      { id: 'short-param', code: 'enemies.filter(e => e.hp > 65)', lineMode: 'single' },
      { id: 'named-param', code: 'enemies.filter(enemy => enemy.hp > 65)', lineMode: 'single' },
    ],
  },
  {
    id: 'moon-edge',
