...
async function seedMidboss(page: Page, clearedBattle12: boolean) {
  await page.goto('/')
  await page.evaluate(
    ({ progressKey, rpgKey, tutorialKey, cleared12 }) => {
      localStorage.clear()
